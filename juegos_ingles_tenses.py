...
def play_game():
    st.title("¡Bienvenido al juego de Tenses!")
        # Descripción del juego
    st.write("""
    En este juego, podrás poner a prueba tus conocimientos sobre los tiempos verbales en inglés. Las preguntas están relacionadas con los siguientes tiempos verbales:
    - **Present Simple**
    - **Present Continuous**
    - **Past Simple**
    - **Present Perfect**
